...
use event_capture_world::exports::ritalin::event_capture;
use crate::core::{engine_core::{self, scanner_engine::CaseSensitivity}, parser_core, scanner_core};
...
impl EventCaptureImpl {
    pub fn new(source: String,config: event_capture::captures::CaptureConfig, engine: engine_core::Engine) -> Self {
