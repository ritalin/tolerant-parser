...
//   * with "ritalin:parser/syntaxes@0.1.0" = "crate::wasi::parser_wasi::bindings::syntax"
...
pub mod exports {
      ...
      pub mod parsers {
        ...
        unsafe impl _rt::WasmResource for Parser{
          ...
          unsafe fn drop(_handle: u32) {
            ...
            #[link(wasm_import_module = "[export]ritalin:parser/parsers@0.1.0")]
            unsafe extern "C" {
  ...
  #[doc(hidden)]
  #[macro_export]
  macro_rules! __export_ritalin_parser_parsers_0_1_0_cabi{
    ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

      #[unsafe(export_name = "ritalin:parser/parsers@0.1.0#create")]
      unsafe extern "C" fn export_create() -> i32 {
        unsafe { $($path_to_types)*::_export_create_cabi::<$ty>() }
      }
      #[unsafe(export_name = "ritalin:parser/parsers@0.1.0#[method]parser.parse")]
      ...
      #[unsafe(export_name = "ritalin:parser/parsers@0.1.0#[method]parser.parse-incremental")]
      ...
      const _: () = {
        #[doc(hidden)]
        #[unsafe(export_name = "ritalin:parser/parsers@0.1.0#[dtor]parser")]
  ...
  #[doc(hidden)]
  pub use __export_ritalin_parser_parsers_0_1_0_cabi;
...
macro_rules! __export_parser_world_impl {
  ...
  $($path_to_types_root)*::exports::ritalin::parser::parsers::__export_ritalin_parser_parsers_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::ritalin::parser::parsers);
  const _: () = {

    #[cfg(target_arch = "wasm32")]
    #[unsafe(link_section = "component-type:wit-bindgen:0.42.1:ritalin:parser@0.1.0:parser-world:imports and exports")]
    #[doc(hidden)]
    #[allow(clippy::octal_escapes)]
    pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2435] = *b"\
...
\x03\0\x1britalin:parser/errors@0.1.0\x05\0\x01B\x08\x01m\x04\x07keyword\x0bnon-\
...
\x1aritalin:parser/types@0.1.0\x05\x01\x02\x03\0\x01\x0bsyntax-kind\x02\x03\0\x01\
...
tem.value\x010\x04\0\x1dritalin:parser/syntaxes@0.1.0\x05\x05\x02\x03\0\x02\x0bs\
yntax-tree\x02\x03\0\0\x0bparse-error\x01B\x11\x02\x03\x02\x01\x06\x04\0\x0bsynt\
...
opes\x0a\0\x08\x04\0\x20[method]parser.parse-incremental\x01\x0b\x01i\x04\x01@\0\
\0\x0c\x04\0\x06create\x01\x0d\x04\0\x1critalin:parser/parsers@0.1.0\x05\x08\x04\
\0!ritalin:parser/parser-world@0.1.0\x04\0\x0b\x12\x01\0\x0cparser-world\x03\0\0\
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.42.1:ritalin:parser@0.1.0:parser-world-with-all-of-its-exports-removed:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
...
\x03\0\x1britalin:parser/errors@0.1.0\x05\0\x04\0Aritalin:parser/parser-world-wi\
th-all-of-its-exports-removed@0.1.0\x04\0\x0b2\x01\0,parser-world-with-all-of-it\
